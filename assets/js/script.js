...
$(document).ready(function () {
    ...
    $(".popover").click(function () {
        ...
        if (navigazione2 != "surreal" && navigazione2 != "pictographic" && navigazione2 != "realistic") {
            ...
            $("#contenuto-tab").load("assets/data/route-info.html");
        }
    });
...
function caricamento_tab(tab) {
    switch (tab) {
        case "3tab_home":
            saveToSessionStorage("tab_temp", "3tab_home");
            ...
            break;
        case "3tab_surreal":
            saveToSessionStorage("tab_temp", "3tab_surreal");
        ...
        case "3tab_pictographic":
            saveToSessionStorage("tab_temp", "3tab_pictographic");
            ...
            break;
        case "3tab_realistic":
            saveToSessionStorage("tab_temp", "3tab_realistic");
